...
testNum = 7;
superpixel = 500;
frselect = [280,50];%frnumber[framestart,number]test1[300,50]test3[2,100]test4[60,60]test7[280,50]test8[120,90]test11[2,100]test12[200,100]
...
%     frout = stack_mean_fbf(frout,frlist(:,:,:,p+1),opticalflow(:,:,1),opticalflow(:,:,2),p);
